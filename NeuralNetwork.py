...
class NeuralNetwork:
    ...
    def backward(self, loss_grad, reg=0.0):
...
class Adam(Optimizer):
    def __init__(
        self, model_params, learning_rate=0.01, beta_1=0.9, beta_2=0.999, epsilon=1e-8
    ):
        super().__init__()
...
def train_nn(
    nn, X, y, optimizer, loss_fn, epochs=100, batch_size=50, reg=1e-3, print_n=10
):
    iter = 0
    losses = []
